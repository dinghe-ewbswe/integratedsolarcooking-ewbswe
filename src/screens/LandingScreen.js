    ...
    <>
      ...
      <ContainerCol style={{ paddingBottom: "3em" }}>
        ...
        <div style={{ marginTop: "2em", fontSize: "24px" }}>
            ...
            health and economy for families that use firewood, charcoal,
            kerosene or gas for cooking. A transition to ISC will reduce
            deforestation and also reduce carbon emission and thus reduce global
            warming.
            <br />
            <br />
            ...
            <ul>
              <li>
                How solar cookers can increase the state of health as well as
                save money, fuel and the environment.
              </li>
              ...
              <li>
                There will also be advice for self-help groups that want to
                start their own business by producing and selling equipment.
              </li>
            </ul>
